            ...
            if os.path.splitext(file)[1].lower() in valid_image_extensions:
                try:
                    ...
                    for ext in valid_image_extensions:
                        potential_mask_path = os.path.join(mask_directory, mask_name + ext)
...
def main():
    ...
    train_image_dir = r'C:\Users\abhir\Desktop\REFUGE2\train\images'
    train_mask_dir = r'C:\Users\abhir\Desktop\REFUGE2\train\mask'
